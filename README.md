...
- ReLU activation outperformed Sigmoid activation for this architectures on the Wisconsin Breast_Cancer dataset, in both accuracy and generalization.
